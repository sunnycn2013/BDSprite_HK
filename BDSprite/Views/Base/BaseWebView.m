...
- (void)setup {
    ...
    [_bridge registerHandler:@"webview" handler:^(id data, WVJBResponseCallback responseCallback) {
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if (navigationType == UIWebViewNavigationTypeLinkClicked && ![url.scheme isEqualToString:@"BDSprite"]) {
        if ([url.host isEqualToString:BDSpriteHost]) {
